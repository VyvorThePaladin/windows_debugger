...
class debugger(): 
    ...
    def load(self, path_to_exe):
        ...
        if kernel32.CreateProcessA(path_to_exe, None, None, None, None, creation_flags, None, None, byref(startupinfo),
    ...
    def get_debug_event(self):
        ...
        if kernel32.WaitForDebugEvent(byref(debug_event), 100):
            # Let's obtain the thread and context infromation
            ...
            if debug_event.dwDebugEventCode == EXCEPTION_DEBUG_EVENT:
                # Obtain the exception code & address.
